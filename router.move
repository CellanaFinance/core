module cellana::router {
    ...
    public entry fun swap_route_entry_from_coin<FromCoin>(
        ...
        primary_fungible_store::deposit(recipient, swap_router(in, amount_out_min, to_tokens, is_stables));
    }
    ...
    public entry fun add_liquidity_and_stake_entry(
        ...
        let tokens_1 = primary_fungible_store::withdraw(lp, token_1, amount_1);
        let tokens_2 = primary_fungible_store::withdraw(lp, token_2, amount_2);
    ...
    public entry fun add_liquidity_and_stake_coin_entry<CoinType>(
        ...
        let token_2 = primary_fungible_store::withdraw(lp, token_2, amount_2);
